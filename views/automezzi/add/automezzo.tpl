            ...
            {{end}} 
                <form class="form-horizontal" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input id="dataInFlotta" name="dataInFlotta" type="text" value="{{.AutomezzoDG.DataInFlotta}}" size="10" class="form-control input-md"/>
                        </div> 
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="dataFineFlotta" name="dataFineFlotta" type="text" value="{{.AutomezzoDG.DataFineFlotta}}" size="10" class="form-control input-md"/>
                        </div>
                    </div>   
                    <!-- TIPOVEICOLO --> 
                    <div class="form-group">
