...
<div class="col-md-10 content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3>Inserimento Contratto Noleggio</h3>
        </div>
            ...
            {{end}} 
                <form class="form-horizontal" method="POST">
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-4">
                        <input id="datainiziocontr" name="datainiziocontr" type=date min=2000-01-01 datetime="2000-01-01 00:00:01" class="form-control input-md" value="{{.DataInizioContratto}}"/>
                        </div> 
                    </div>
                    <!-- DATA FINE CONTRATTO --> 
                    <div class="form-group">                
                        ...
                        <div class="col-md-4">
                        <input id="datafinecontratto" name="datafinecontratto" type=date min=2000-01-01 datetime="2000-01-01 00:00:01" class="form-control input-md" value="{{.DataFineContratto}}"/>
                        </div> 
                    </div>                                        
                    <!-- RIPARAMETRIZZAZIONE --> 
                    <div class="form-group">                
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-4">
                        <input id="canonetotale" name="canonetotale" type="text" value="{{.CanoneTotale}}" class="form-control input-md"/>
                        </div> 
                    </div>
                    <!-- KM CONTRATTUALI --> 
                    <div class="form-group">                
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-4">
                        <input id="imptotale" name="imptotale" type="text" value="{{.ImpTotale}}" class="form-control input-md"/>
                        </div> 
                    </div>      
                    <!-- KM INIZIO GESTIONE--> 
                    <div class="form-group">                
