 ...
 <div class="col-md-10 content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3>Gestione Contratti Noleggio</h3>
        </div>
        <div class="panel-body">           
            ...
            <div class="filterable">
                    ...
                    <thead>
                        <tr class="filters">
                            <th><a href="http://{{.domainname}}/automezzi/view/contrattinol/{{if eq .order "ncontratto"}}-{{end}}ncontratto!{{.offset}}!{{.query}}">Numero Contratto</a></th>
                            <th><a href="http://{{.domainname}}/automezzi/view/contrattinol/{{if eq .order "data_cont"}}-{{end}}data_cont!{{.offset}}!{{.query}}">Data Contratto</a></th>
                    ...
                    <div class="form-group col-lg-2" >      
                            ...
                            <div class="form-group col-lg-8">
                                <nav>
                                    <ul class="pager">
                                        <li>
                                            <a href="http://{{.domainname}}/automezzi/view/contrattinol/{{.order}}!0!{{.query}}">&lt;&lt; Inizio</a>
                                        </li>
                                        {{if .showprev}}
                                            <li>
                                                <a href="http://{{.domainname}}/automezzi/view/contrattinol/{{.order}}!{{.prev}}!{{.query}}">&lt; Precendente</a>
                                            </li>
                                        {{end}}
                                        {{if .next}}
                                            <li>
                                                <a href="http://{{.domainname}}/automezzi/view/contrattinol/{{.order}}!{{.next}}!{{.query}}">Successivo &gt;</a>
                                            </li>
                                        {{end}}
                                        <li>
                                            <a href="http://{{.domainname}}/automezzi/view/contrattinol/{{.order}}!{{.end}}!{{.query}}">Fine &gt;&gt;</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
